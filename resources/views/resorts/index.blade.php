                                ...
                                @forelse ($resorts as $resort)
                                    <div class="col-xl-4 col-lg-4 col-sm-6">
                                        <div class="hotel-card">
                                            <div class="hotel-img imgEffect4">
                                                ...
                                                <div class="rating-badge-car">
                                                    <div class="rating">
                                                        ...
                                                        <p class="pera">4.8 (15 Reviews)</p>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="hotel-content">
                                                <h4 class="area-name">
                                                    <a href="{{ route('resort.show', $resort) }}">{{ $resort->title }}</a>
                                                </h4>
                                                <div class="location">
                                                    <i class="ri-map-pin-line"></i>
                                                ...
                                                <div class="hotel-person">
                                                    {{-- <div class="count">
                                                        ...
                                                        <p class="pera">2 Pools</p>
                                                    </div>
                                                    <div class="count">
                                                        <div class="icon text-primary">
                                                            <i class="ri-tools-fill"></i>
                                                        </div>
                                                        <p class="pera text-capitalize">2 Bathrooms</p>
                                                    </div>
                                                    <div class="count">
                                                        <div class="icon text-primary">
                                                            <i class="ri-bus-2-line"></i>
                                                        </div>
                                                        <p class="pera text-capitalize">3 Beds</p>
                                                    </div> --}}
                                                    <div class="count">
                                                        <div class="icon text-primary">
                                                            <i class="ri-timer-line"></i>
                                                        </div>
                                                        <p class="pera text-capitalize">
                                                            {{ $resort->duration }}</p>
                                                    </div>
                                                    <div class="count">
                                                        <div class="icon text-primary">
                                                        ...
                                                        <p class="pera text-capitalize">
                                                            {{ $resort->number_of_individuals }}</p>
                                                    </div>
                                                </div>
                                                <div class="cart-footer d-flex flex-wrap justify-content-between">
                                                    ...
                                                    <a href="{{ route('resort.show', $resort) }}" class="browse-btn">book now</a>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
