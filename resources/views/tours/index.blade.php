...
@section('content')
    <main>
        ...
        <section class="breadcrumbs-area breadcrumb-bg">
            <div class="container">
                <h1 class="title wow fadeInUp" data-wow-delay="0.0s">Tours</h1>
                                        ...
                                        <div class="package-card">
                                            <div class="package-img imgEffect4">
                                                <a href="{{ route('tour.show', $tour) }}">
                                                    <img src="{{ asset('storage/tour/' . $tour->image_primary) }}"
                                                        alt="travello">
                                                </a>
                                            ...
                                            <div class="package-content">
                                                <h4 class="area-name">
                                                    <a href="{{ route('tour.show', $tour) }}">{{ $tour->title }}</a>
                                                </h4>
                                                <div class="location">
                                                    <i class="ri-map-pin-line"></i>
                                                ...
                                                <div class="packages-person">
                                                    ...
                                                    <div class="count">
                                                        ...
                                                        <p class="pera">{{ $tour->number_of_individuals }}</p>
                                                    </div>
                                                </div>
