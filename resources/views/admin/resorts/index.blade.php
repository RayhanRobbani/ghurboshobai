            ...
            <div class="row g-4">
                <div class="col-lg-12">
                    <div class="small-tittle-two pb-0">
                        <h5 class="title font-600 text-capitalize mb-0">List Resorts</h5>
                    </div>
                </div>
            </div>
        </div>
                            ...
                            <div class="row">
                                <div class="col-xl-12">
                                    <div class="small-tittle-two pb-0 mb-10 flex justify-content-between">
                                        ...
                                        <a href="{{ route('admin.resort.create') }}" class="btn-primary-sm radius-30"><i
                                                ...
                                                @forelse ($resorts as $resort)
                                                    <tr>
                                                        ...
                                                        <td class="ticket-subject">
                                                            <a href="#"
                                                                class="line-clamp-1 text-primary text-capitalize">{{ $resort->title }}</a>
                                                        </td>
                                                        <td>{{ $resort->location->name }}</td>
                                                        <td>{{ $resort->duration }}</td>
                                                        <td>{{ $resort->number_of_individuals }}</td>
                                                        <td>৳{{ $resort->price }}</td>
                                                        <td>
                                                            <div class="d-flex gap-6">
                                                                ...
                                                                <a href="{{ route('admin.resort.edit', $resort) }}"
                                                                    class="text-16 text-paragraph"><i
                                                                        class="ri-edit-2-fill"></i></a>
                                                                <form action="{{ route('admin.resort.destroy', $resort) }}"
                                                                    method="POST">
                                                                    @method('DELETE')
                                                                    @csrf
                                                                    <button
