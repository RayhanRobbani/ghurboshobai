            ...
            <div class="row g-4">
                <div class="col-lg-12">
                    <div class="small-tittle-two pb-0">
                        <h5 class="title font-600 text-capitalize mb-0">Tour Booking</h5>
                    </div>
                </div>
            </div>
        </div>
                                                    ...
                                                    @forelse ($tours as $booking)
                                                        <tr>
                                                            ...
                                                            <td class="ticket-subject">
                                                                <a href="{{ route('tour.show', $booking->tour_id) }}"
                                                                    class="line-clamp-1 text-primary text-capitalize">{{ $booking->tour->title }}</a>
                                                            </td>
                                                            <td class="min-w-120">
                                                                {{ $booking->date_from }}
                                    ...
                                    <div class="col-xl-12">
                                        ...
                                        <div class="data-show-table">
                                            <table class="table-responsive">
                                                ...
                                                <tbody>
                                                    @forelse ($tours->where('status', 'Pending') as $booking)
                                                        <tr>
                                                            <td>{{ $loop->iteration }}</td>
                                                            <td>
                                                                {{ $booking->user->name }}<br>
                                    ...
                                    <div class="col-xl-12">
                                        ...
                                        <div class="data-show-table">
                                            <table class="table-responsive">
                                                ...
                                                <tbody>
                                                    @forelse ($tours->where('status', 'Processing') as $booking)
                                                        <tr>
                                                            <td>{{ $loop->iteration }}</td>
                                                            <td>
                                                                {{ $booking->user->name }}<br>
                                    ...
                                    <div class="col-xl-12">
                                        ...
                                        <div class="data-show-table">
                                            <table class="table-responsive">
                                                ...
                                                <tbody>
                                                    @forelse ($tours->where('status', 'Confirmed') as $booking)
                                                        <tr>
                                                            <td>{{ $loop->iteration }}</td>
                                                            <td>
                                                                {{ $booking->user->name }}<br>
                                    ...
                                    <div class="col-xl-12">
                                        ...
                                        <div class="data-show-table">
                                            <table class="table-responsive">
                                                ...
                                                <tbody>
                                                    @forelse ($tours->where('status', 'Cancelled') as $booking)
                                                        <tr>
                                                            <td>{{ $loop->iteration }}</td>
                                                            <td>
                                                                {{ $booking->user->name }}<br>
