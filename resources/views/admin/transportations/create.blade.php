...
@section('title', __('Create New Transportation') . ' | ')
            ...
            <div class="row g-4">
                <div class="col-lg-12">
                    <div class="small-tittle-two pb-0">
                        <h5 class="title font-600 text-capitalize mb-0">Create New Transportation</h5>
                    </div>
                </div>
            </div>
        </div>
                                    ...
                                    <div class="col-xl-12 col-lg-12">
                                        <div class="contact-form mb-24">
                                            ...
                                            <input class="contact-input" type="text" name="driver_contact"
                                                id="driver_contact" placeholder="Driver's Contact" required>
                                        </div>
                                    </div>
