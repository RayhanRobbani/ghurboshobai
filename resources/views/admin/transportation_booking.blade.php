            ...
            <div class="row g-4">
                <div class="col-lg-12">
                    <div class="small-tittle-two pb-0">
                        <h5 class="title font-600 text-capitalize mb-0">Transportation Booking</h5>
                    </div>
                </div>
            </div>
        </div>
                                    ...
                                    <div class="col-xl-12">
                                        ...
                                        <div class="data-show-table">
                                            <table class="table-responsive">
                                                ...
                                                <tbody>
                                                    @forelse ($transportations as $booking)
                                                        <tr>
                                                            ...
                                                            <td class="ticket-subject">
                                                                <a href="{{ route('transportation.show', $booking->transportation_id) }}"
                                                                    class="line-clamp-1 text-primary text-capitalize">{{ $booking->transportation->title }}</a>
                                                            </td>
                                                            <td class="min-w-120">
                                                                {{ $booking->date_from }}
                                                            ...
                                                            <td>
                                                                <div class="d-flex gap-6">
                                                                    @if ($booking->status == 'Pending')
                                                                        <a href="{{ route('admin.status_update', [$booking, 'Processing']) }}"
                                                                            class="text-16 text-paragraph"><i
                                                                                class="ri-hourglass-line text-warning"
                                                                                data-bs-toggle="tooltip" data-bs-placement="top"
                                                                                title="Mark Processing"></i></a>
                                                                    @endif
                                                                    @if ($booking->status == 'Processing')
                                                                        <a href="{{ route('admin.status_update', [$booking, 'Confirmed']) }}"
                                                                            class="text-16 text-paragraph"><i
                                                                                class="ri-checkbox-circle-line text-success"
                                                                                data-bs-toggle="tooltip" data-bs-placement="top"
                                                                                title="Mark Confirmed"></i></a>
                                                                        <a href="{{ route('admin.status_update', [$booking, 'Cancelled']) }}"
                                                                            class="text-16 text-paragraph"><i
                                    ...
                                    <div class="col-xl-12">
                                        ...
                                        <div class="data-show-table">
                                            <table class="table-responsive">
                                                ...
                                                <tbody>
                                                    @forelse ($transportations->where('status', 'Pending') as $booking)
                                                        <tr>
                                                            <td>{{ $loop->iteration }}</td>
                                                            <td>
                                                                {{ $booking->user->name }}<br>
                                    ...
                                    <div class="col-xl-12">
                                        ...
                                        <div class="data-show-table">
                                            <table class="table-responsive">
                                                ...
                                                <tbody>
                                                    @forelse ($transportations->where('status', 'Processing') as $booking)
                                                        <tr>
                                                            <td>{{ $loop->iteration }}</td>
                                                            <td>
                                                                {{ $booking->user->name }}<br>
                                    ...
                                    <div class="col-xl-12">
                                        ...
                                        <div class="data-show-table">
                                            <table class="table-responsive">
                                                ...
                                                <tbody>
                                                    @forelse ($transportations->where('status', 'Confirmed') as $booking)
                                                        <tr>
                                                            <td>{{ $loop->iteration }}</td>
                                                            <td>
                                                                {{ $booking->user->name }}<br>
                                    ...
                                    <div class="col-xl-12">
                                        ...
                                        <div class="data-show-table">
                                            <table class="table-responsive">
                                                ...
                                                <tbody>
                                                    @forelse ($transportations->where('status', 'Cancelled') as $booking)
                                                        <tr>
                                                            <td>{{ $loop->iteration }}</td>
                                                            <td>
                                                                {{ $booking->user->name }}<br>
