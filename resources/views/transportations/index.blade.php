@extends('layouts.app')
@section('title', __('Transportations') . ' | ')
...
@section('content')
    <main>
        ...
        <!-- transports List area S t a r t -->
        <section class="tour-list-section top-bottom-padding2">
            <div class="container">
                <div class="row g-4">
                    <div class="col-xl-3">
                            ...
                            <div class="search-filter">
                                ...
                                <div class="tour-search">
                                    ...
                                    <div class="dropdown-section">
                                        ...
                                        <div class="date-result">01/12/2025</div>
                                    </div>
                                ...
                                @forelse ($transportations as $transportation)
                                    <div class="col-xl-4 col-lg-4 col-sm-6">
                                        <div class="transports-card">
                                            <div class="transports-img imgEffect4">
                                                <a href="{{ route('transportation.show', $transportation) }}">
                                                    <img src="{{ asset('storage/transportation/' . $transportation->image_primary) }}" alt="image_primary">
                                                </a>
                                                <div class="rating-badge-car">
                                                    <div class="rating">
                                                        <i class="ri-star-s-fill"></i>
                                                        <p class="pera">5 (20 Reviews)</p>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="transports-content">
                                                <h4 class="area-name">
                                                    <a href="{{ route('transportation.show', $transportation) }}">{{ $transportation->title }}</a>
                                                </h4>
                                                <div class="location">
                                                    <i class="ri-map-pin-line"></i>
                                                ...
                                                <div class="transports-person">
                                                    {{-- <div class="count">
                                                        ...
                                                        <p class="pera">6542 Miles</p>
                                                    </div>
                                                    <div class="count">
                                                        <div class="icon text-primary">
                                                            <i class="ri-tools-fill"></i>
                                                        </div>
                                                        <p class="pera text-capitalize">Automatic</p>
                                                    </div>
                                                    <div class="count">
                                                        <div class="icon text-primary">
                                                            <i class="ri-bus-2-line"></i>
                                                        </div>
                                                        <p class="pera text-capitalize">120 Trip</p>
                                                    </div> --}}
                                                    <div class="count">
                                                        <div class="icon text-primary">
                                                            <i class="ri-run-line"></i>
                                                        </div>
                                                        <p class="pera text-capitalize">{{ $transportation->number_of_individuals }}</p>
                                                    </div>
                                                </div>
                                                <div class="cart-footer d-flex flex-wrap justify-content-between">
                                                    <div class="d-flex gap-6 align-items-center">
                                                        <p class="pera">৳{{ $transportation->price }}</p>
                                                        <p class="sub-pera text-12 text-capitalize">/person</p>
                                                    </div>
                                                    <a href="{{ route('transportation.show', $transportation) }}" class="browse-btn">book now</a>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
