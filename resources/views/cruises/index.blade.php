                                        ...
                                        <div class="package-card">
                                            <div class="package-img imgEffect4">
                                                <a href="{{ route('cruise.show', $cruise) }}">
                                                    <img src="{{ asset('storage/cruise/' . $cruise->image_primary) }}"
                                                        alt="travello">
                                                </a>
                                            ...
                                            <div class="package-content">
                                                <h4 class="area-name">
                                                    <a href="{{ route('cruise.show', $cruise) }}">{{ $cruise->title }}</a>
                                                </h4>
                                                <div class="location">
                                                    <i class="ri-map-pin-line"></i>
                                                ...
                                                <div class="packages-person">
                                                    ...
                                                    <div class="count">
                                                        ...
                                                        <p class="pera">{{ $cruise->number_of_individuals }}</p>
                                                    </div>
                                                </div>
