@extends('layouts.app')
@section('title', __('Cruise Details') . ' | ')
...
@section('content')
    <main>
        ...
        <section class="breadcrumbs-area breadcrumb-bg">
            <div class="container">
                <h1 class="title wow fadeInUp" data-wow-delay="0.0s">Cruise Details</h1>
                    ...
                    <nav aria-label="breadcrumb" class="breadcrumb-nav wow fadeInUp" data-wow-delay="0.1s">
                        <ul class="breadcrumb listing">
                            ...
                            <li class="breadcrumb-item single-list" aria-current="page">
                                <a href="javascript:void(0)" class="single active">Cruise Details</a>
                            </li>
                        </ul>
                    </nav>
                </div>
                    ...
                    <div class="swiper tourSwiper-active">
                        <div class="swiper-wrapper">
                            <div class="swiper-slide">
                                <img src="{{ asset('storage/cruise/' . $cruise->image_primary) }}" alt="image_primary">
                            </div>
                            <div class="swiper-slide">
                                <img src="{{ asset('storage/cruise/' . $cruise->image_secondary_1) }}"
                                    alt="trimage_secondary_1avello">
                            </div>
                            <div class="swiper-slide">
                                <img src="{{ asset('storage/cruise/' . $cruise->image_secondary_2) }}"
                                    alt="image_secondary_2">
                            </div>
                            <div class="swiper-slide">
                                <img src="{{ asset('storage/cruise/' . $cruise->image_secondary_3) }}"
                                    alt="image_secondary_3">
                            </div>
                            @if ($cruise->image_secondary_4)
                                <div class="swiper-slide">
                                    <img src="{{ asset('storage/cruise/' . $cruise->image_secondary_4) }}"
                                        alt="image_secondary_4">
                                </div>
                            @endif
                            @if ($cruise->image_secondary_5)
                                <div class="swiper-slide">
                                    <img src="{{ asset('storage/cruise/' . $cruise->image_secondary_5) }}"
                                        alt="image_secondary_5">
                                </div>
                            @endif
                            @if ($cruise->image_secondary_6)
                                <div class="swiper-slide">
                                    <img src="{{ asset('storage/cruise/' . $cruise->image_secondary_6) }}"
                                        alt="image_secondary_6">
                                </div>
                            @endif
                            @if ($cruise->image_secondary_7)
                                <div class="swiper-slide">
                                    <img src="{{ asset('storage/cruise/' . $cruise->image_secondary_7) }}"
                                        alt="image_secondary_7">
                                </div>
                            @endif
                            @if ($cruise->image_secondary_8)
                                <div class="swiper-slide">
                                    <img src="{{ asset('storage/cruise/' . $cruise->image_secondary_8) }}"
                                        alt="image_secondary_8">
                                </div>
                            @endif
                            @if ($cruise->image_secondary_9)
                                <div class="swiper-slide">
                                    <img src="{{ asset('storage/cruise/' . $cruise->image_secondary_9) }}"
                                        alt="image_secondary_9">
                                </div>
                            @endif
                            @if ($cruise->image_secondary_10)
                                <div class="swiper-slide">
                                    <img src="{{ asset('storage/cruise/' . $cruise->image_secondary_10) }}"
                                        alt="image_secondary_10">
                                </div>
                            @endif
                            @if ($cruise->image_secondary_11)
                                <div class="swiper-slide">
                                    <img src="{{ asset('storage/cruise/' . $cruise->image_secondary_11) }}"
                                        alt="image_secondary_11">
                                </div>
                            @endif
                            @if ($cruise->image_secondary_12)
                                <div class="swiper-slide">
                                    <img src="{{ asset('storage/cruise/' . $cruise->image_secondary_12) }}"
                                        alt="image_secondary_12">
                                </div>
                            @endif
                            @if ($cruise->image_secondary_13)
                                <div class="swiper-slide">
                                    <img src="{{ asset('storage/cruise/' . $cruise->image_secondary_13) }}"
                                        alt="image_secondary_13">
                                </div>
                            @endif
                            @if ($cruise->image_secondary_14)
                                <div class="swiper-slide">
                                    <img src="{{ asset('storage/cruise/' . $cruise->image_secondary_14) }}"
                    ...
                    <div class="container">
                        ...
                        <div class="details-heading">
                            <div class="d-flex flex-column">
                                <h4 class="title text-capitalize">{{ $cruise->title }}</h4>
                                <div class="d-flex flex-wrap align-items-center gap-30 mt-16">
                                    <div class="location">
                                        <i class="ri-map-pin-line"></i>
                                        <div class="name">{{ $cruise->location->name }}</div>
                                    </div>
                                    <div class="divider"></div>
                                    <div class="d-flex align-items-center flex-wrap gap-20">
                                        <div class="count">
                                            <i class="ri-time-line"></i>
                                            <p class="pera">{{ $cruise->duration }}</p>
                                        </div>
                                        <div class="count">
                                            <i class="ri-user-line"></i>
                                            <p class="pera">{{ $cruise->number_of_individuals }}n</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="mt-30">
                            <div class="row g-4">
                                ...
                                <div class="col-xl-8 col-lg-7">
                                    ...
                                    <div class="tour-include-exclude radius-6">
                                        <div class="includ-exclude-point">
                                            ...
                                            {{-- <ul class="expect-list">
                                                <li class="list">{{ $cruise->included }}</li>
                                            </ul> --}}
                                            {{ $cruise->included }}
                                        </div>
                                        <div class="divider"></div>
                                        <div class="includ-exclude-point">
                                            ...
                                            {{-- <ul class="expect-list">
                                                <li class="list">{{ $cruise->excluded }}</li>
                                            </ul> --}}
                                            {{ $cruise->excluded }}
                                        </div>
                                    </div>
                                    ...
                                    @if (
                                            $cruise->tour_plan_day_1 ||
                                            $cruise->tour_plan_day_2 ||
                                            $cruise->tour_plan_day_3 ||
                                            $cruise->tour_plan_day_4 ||
                                            $cruise->tour_plan_day_5
                                        )
                                        <!-- Tour Plan accordion-->
                                                        ...
                                                        <div class="accordion-item">
                                                            ...
                                                            <div id="panelsStayOpen-collapseOne"
                                                                ...
                                                                <div class="accordion-body">
                                                                    <p class="pera mb-16">{{ $cruise->tour_plan_day_1 }}</p>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    @endif

                                                    @if ($cruise->tour_plan_day_2)
                                                        <div class="accordion-item">
                                                            ...
                                                            <div id="panelsStayOpen-collapseTwo"
                                                                ...
                                                                <div class="accordion-body">
                                                                    <p class="pera mb-16">{{ $cruise->tour_plan_day_2 }}</p>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    @endif

                                                    @if ($cruise->tour_plan_day_3)
                                                        <div class="accordion-item">
                                                            ...
                                                            <div id="panelsStayOpen-collapseThree"
                                                                ...
                                                                <div class="accordion-body">
                                                                    <p class="pera mb-16">{{ $cruise->tour_plan_day_3 }}</p>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    @endif

                                                    @if ($cruise->tour_plan_day_4)
                                                        <div class="accordion-item">
                                                            ...
                                                            <div id="panelsStayOpen-collapseFour"
                                                                ...
                                                                <div class="accordion-body">
                                                                    <p class="pera mb-16">{{ $cruise->tour_plan_day_4 }}</p>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    @endif

                                                    @if ($cruise->tour_plan_day_5)
                                                        <div class="accordion-item">
                                                            ...
                                                            <div id="panelsStayOpen-collapseFive"
                                                                ...
                                                                <div class="accordion-body">
                                                                    <p class="pera mb-16">{{ $cruise->tour_plan_day_5 }}</p>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    @endif
